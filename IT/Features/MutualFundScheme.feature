# High-level description of the Mutual Fund API functionality.
Feature: Mutual Fund Schemes API
    As an API consumer
    I want to retrieve mutual fund schemes
    So I can analyze investment options

# Tests the standard successful retrieval of data.
...
# Tests the system's resilience and error handling.
